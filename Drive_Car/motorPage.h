    ...
    <div class="container-fluid">
      <div class="col-xs-12"  style="height: 100vh">
        ...
        <div class="row" style="height: 33.33%; padding-bottom:1em">
          ...
          <div class="col-xs-4" style="height: 100%; text-align: center">
            <button id="center" type="button" class="btn btn-default" style="height: 100%; width: 100%" onmousedown='makeAjaxCall("center")' onmouseup='makeAjaxCall("steerStop")' ontouchstart='makeAjaxCall("center")' ontouchend='makeAjaxCall("steerStop")'>Center</button>
          </div>
          <div class="col-xs-4" style="height: 100%; text-align: center">
            <button id="stop" type="button" class="btn btn-default" style="height: 100%; width: 100%" onmousedown='makeAjaxCall("stopped")' onmouseup='makeAjaxCall("steerStop")' ontouchstart='makeAjaxCall("stopped")' ontouchend='makeAjaxCall("steerStop")'>Stop</button>
          </div>
